Shader "Custom/PlanetRingShader"
{
    Properties
    {
        ...
        _ColorRing ("ColorRing", Color) = (0.2,0.2,0.7,1)
        _MainTex ("Albedo (RGB)", 2D) = "white" {}
        _Emission("Emission", Color) = (1,1,1,1)
        _Height("Height", Range(-1,1)) = 0
        _Seed("Seed", Range(0,10000)) = 10
        _RingInnerRadius ("_RingInnerRadius", Range(0,5)) = 2
        _RingOuterRadius ("_RingOuterRadius", Range(0,5)) = 3
    }
    SubShader
    {
        ...
        void vert (inout appdata_full v, out Input o)
        {
            ...
            v.vertex.y = 0;
            v.vertex.xyz *= _RingOuterRadius;
        }

        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            o.Albedo = _ColorRing.rgb;
            o.Alpha = _ColorRing.a;
        }
        ENDCG
    }
    FallBack "Diffuse"

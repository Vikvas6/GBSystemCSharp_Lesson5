...
public class Fractal5 : MonoBehaviour
{
    struct FractalPart
    {
    ...
    [SerializeField, Range(1, 9)] private int _depth = 4;
    ...
    private void Update()
    {
        ...
        for (var li = 1; li < _parts.Length; li++)
        {
            ...
            jobHandle = job.ScheduleParallel(_parts[li].Length, 5, jobHandle);
        }
        jobHandle.Complete();
    ...
    [BurstCompile(CompileSynchronously = false, FloatPrecision = FloatPrecision.Standard, FloatMode = FloatMode.Fast)]
    private struct UpdateFractalLevelJob : IJobFor
    {
        ...
        public void Execute(int index)
        {
            ...
            part.WorldPosition = float3(parent.WorldPosition) + mul(parent.WorldRotation, _positionOffset * Scale * part.Direction);
            Parts[index] = part;
